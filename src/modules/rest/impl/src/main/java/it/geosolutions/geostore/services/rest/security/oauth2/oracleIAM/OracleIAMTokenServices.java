 ...
 */
public class OracleIAMTokenServices extends GeoStoreRemoteTokenServices {

    public OracleIAMTokenServices(String principalKey) {
        super(new OracleIAMAccessTokenConverter(principalKey));
    }
