...
/**
 * OracleIAM AccessTokenConverter. Retrieves Authentication information from the AccessToken.
 */
public class OracleIAMAccessTokenConverter extends GeoStoreAccessTokenConverter {



    public OracleIAMAccessTokenConverter(String principalKey) {
        super(principalKey);
    }
    ...
    private Set<String> parseScopes(Map<String, ?> map) {
        // Parsing of scopes coming back from OracleIAM are slightly different from
